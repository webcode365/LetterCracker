...
function doUnscramble() {
  ...
  var loadingText    = loadingState && loadingState.querySelector('span');
  var resultsSection = document.getElementById('resultsSection');
  if (loadingText)    loadingText.textContent = 'Searching words…';
  if (loadingState)   loadingState.style.display   = 'flex';
  if (resultsSection) resultsSection.style.display = 'none';

  /* unscramble uses the 370,079-word shard system — loads only the needed shard */
